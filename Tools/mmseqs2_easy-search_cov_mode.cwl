...
inputs:
  ...
  - id: format_output
    ...
    default: "query,target,pident,fident,nident,qcov,tcov,alnlen,mismatch,gapopen,qlen,qstart,qend,tlen,tstart,tend,evalue,bits,qheader,theader,qaln,taln,qframe,tframe,mismatch"
